...
extern void cmd_write(PlotWindow &w, Command &cmd);
...
extern void cmd_assign(PlotWindow &w, Command &cmd);
...
void gui_cmd(Command &cmd, PlotWindow &w)
{
	try
	{
		switch (cmd.cid)
		{
			...
			case CID::WRITE:  cmd_write (w, cmd); break;
			...
			case CID::ASSIGN: cmd_assign(w, cmd); break;
			case CID::CG:     cmd_cg    (w, cmd); break;
